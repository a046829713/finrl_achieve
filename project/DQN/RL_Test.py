...
strategy = Strategy(strategytype="DQN",
                    ...
                    model_count_path=r'DQN\Meta\BNBUSDT.pt')

strategy.load_data(local_data_path=r'DQN\simulation\data\BTCUSDT-F-30-Min.csv')


# re_evaluate = RL_evaluate()# 損壞
# Backtest(re_evaluate,strategy).order_becktest(re_evaluate.record_orders,ifplot = True)